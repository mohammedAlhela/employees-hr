...
class EmployeesSalariesExpensesDeductionsExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    public function collection()
    {
           ...
           if ($this->formArray[1] == 'custom_date') {
            $employees = collect(EmployeesSalariesExpensesDeductionsResource::collection(Employee::whereIn('id', $this->getArrayFromString($this->formArray[0]))->
